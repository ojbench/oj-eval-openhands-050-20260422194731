...
def main():
    ...
    submit_file_parser = subparsers.add_parser("submit-file", help="Submit code content from a local file as src.hpp")
    submit_file_parser.add_argument("--problem-id", type=int, required=True, help="Problem ID")
    submit_file_parser.add_argument("--file", type=str, required=True, help="Path to the file to upload (e.g., src.hpp)")
